...
class BaseSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.filling_date = None
        self.base_url = 'https://www.sec.gov'
        self.CIK_lookup_url = "https://www.sec.gov/cgi-bin/browse-edgar?CIK=%s&owner=exclude&action=getcompany"
        self.company_name_lookup_url = "https://www.sec.gov/cgi-bin/browse-edgar?company=%s&match=contains&" + \
                                       "filenum=&State=&Country=&SIC=&myowner=exclude&action=getcompany"
